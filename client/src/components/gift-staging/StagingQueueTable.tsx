        ...
        <tbody>
          {rows.map((row) => (
            ...
            >
              ...
              {showColumn('donor') ? <td className={dataCell}>{row.donorSummary}</td> : null}
              {showColumn('amount') ? (
                <td className={dataCell}>
              ...
              {showColumn('updated') ? <td className={dataCell}>{row.formattedDate}</td> : null}
              {showColumn('eligibility') ? (
                <td className={dataCell}>
